...
<div class="node-1">
  ...
  <div class="content-14">
    <form class="form-container-15" action="process_reclamation.php" method="post" id="complaintForm" enctype="multipart/form-data">
      ...
      <?php else: ?>
        ...
        <p class="logged-in-message">Vous êtes connecté en tant que <?= htmlspecialchars($_SESSION['user']['name']) ?></p>
      <?php endif; ?>
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" id="trainNumber" name="trainNumber" class="form-control" placeholder="Ex: 1234" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="description" name="description" class="form-control" placeholder="Décrivez votre problème en détail..." required></textarea>
        </div>
