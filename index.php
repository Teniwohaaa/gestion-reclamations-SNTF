      ...
      <main>
        ...
        <section class="quick-access">
          ...
          <div class="quick-cards">
            <div class="quick-card">
              <img
                src="images/quickico1.png"
                alt="Nouvelle réclamation"
                class="quick-icon"
              />
              <a href="reclamation.php" class="quick-link"
                >Nouvelle réclamation</a
              >
            </div>
            <div class="quick-card">
              <img
                src="images/quickico2.png"
                alt="Suivi de réclamation"
                class="quick-icon"
              />
              <a href="suividerec.php" class="quick-link"
                >Suivi de réclamation</a
              >
            </div>
            <div class="quick-card">
          ...
          <div class="testimonial-cards">
            <div class="testimonial-card">
              ...
              <div class="testimonial-author">
                <div class="avatar"><div class="initials">KM</div></div>
            ...
            <div class="testimonial-card">
              ...
              <div class="testimonial-author">
                <div class="avatar"><div class="initials">FB</div></div>
                <div class="author-info">
            ...
            <div class="testimonial-card">
              ...
              <div class="testimonial-author">
                <div class="avatar"><div class="initials">YB</div></div>
                <div class="author-info">
        ...
        <section class="cta-section">
          ...
          <div class="cta-buttons">
            <a href="reclamation.php" class="btn primary"
              >Soumettre une réclamation</a
            >
