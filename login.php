...
<div class="node-1">
    ...
    <?php if (isset($_SESSION['error'])): ?>
        <div class="alert" style="background-color: #fee2e2; color: #dc2626; padding: 1rem; margin: 1rem auto; max-width: 600px; border-radius: 6px; text-align: center;">
    ...
    <div class="content-14">
        <form class="form-container-15" action="auth.php" method="post">
            ...
            <p style="text-align: center; margin-top: 1rem; color: var(--text-rgb-75-85-99);">
                Vous n'avez pas de compte ? <a href="reclamation.php" style="color: var(--text-rgb-0-82-155);">Soumettre une réclamation</a>
            </p>
        </form>
        ...
        <div class="info-cards">
            <div class="info-card">
                ...
                <p class="card-text">Si vous rencontrez des problèmes pour vous connecter, contactez notre service client au 021 XX XX XX ou par email à support@sntf.dz</p>
            </div>
        </div>
    </div>
</div>
