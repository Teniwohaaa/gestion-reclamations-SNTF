...
// Récupérer une réclamation spécifique si ID fourni
...
if (isset($_GET['id'])) {
    ...
    if ($selectedComplaint) {
        ...
        $stmt = $conn->prepare("SELECT c.*, u.name as agent_name 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comment'])) {
    if ($selectedComplaint) {
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO reclamation_comments (reclamation_id, commentaire) VALUES (?, ?)");
            $stmt->execute([$selectedComplaint['id'], $comment]);
...
<head>
    ...
    <link rel="stylesheet" href="Styles/suivi_reclamation.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="search-section card">
            ...
            <form class="search-form" method="GET">
                <div class="form-group">
                    ...
                    <input type="text" id="reference" name="id" placeholder="Ex: 123" value="<?= isset($_GET['id']) ? htmlspecialchars($_GET['id']) : '' ?>">
                </div>
                    ...
                    <div class="timeline">
                        <div class="step completed">
                            ...
                            <div class="step-content">
                                ...
                                <span class="date"><?= date('d/m/Y à H:i', strtotime($selectedComplaint['created_at'])) ?></span>
                        ...
                        <div class="step completed">
                            ...
                            <div class="step-content">
                                ...
                                <span class="date"><?= date('d/m/Y à H:i', strtotime($selectedComplaint['updated_at'])) ?></span>
                                <p>Votre réclamation est en cours d'analyse par notre service client.</p>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <div class="step <?= in_array($selectedComplaint['statut'], ['traitee', 'cloturee']) ? 'completed' : ($selectedComplaint['statut'] === 'en_cours' ? 'active' : '') ?>">
                            <div class="step-marker">
                        ...
                        <div class="step <?= $selectedComplaint['statut'] === 'cloturee' ? 'completed' : ($selectedComplaint['statut'] === 'traitee' ? 'active' : '') ?>">
                            <div class="step-marker">
                    ...
                    <?php if (count($comments) > 0): ?>
                        ...
                        <div class="notification">
                            <div class="notification-header">
                                ...
                                <span class="notification-date"><?= date('d/m/Y à H:i', strtotime($comment['created_at'])) ?></span>
                            </div>
        ...
        <div class="help-section card">
            ...
            <p>Si vous avez des questions concernant votre réclamation, n'hésitez pas à contacter notre service client au 021 XX XX XX (du lundi au vendredi, de 8h à 17h) ou par email à reclamations@sntf.dz</p>
        </div>
    </div>
